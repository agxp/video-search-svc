...
func main() {
	...
	zapLogger := logger.With(zap.String("service", "video-search-svc"))
	...
	repo := &SearchRepository{s3, pg, tracer, vh}

	// Create a new service. Optionally include some options here.
	srv := micro.NewService(

		// This name must match the package name given in your protobuf definition
		micro.Name("video_search"),
	...
	// Register handler
	pb.RegisterSearchHandler(srv.Server(), &service{repo, tracer, zapLogger})
